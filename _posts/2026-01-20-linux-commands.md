...
| :------- | :--------- | :--------------------------- | :------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **grep** | **查找**     | `grep [选项] "模式" [文件...]`     | 按行搜索，打印匹配行     | **1. 基础查找：** `grep "error" server.log`<br>**2.递归查找目录：** `grep -r "main(" ./src/`<br>**3. 显示匹配上下文：** `grep -A 2 -B 2 "Exception" error.log`  (前后各2行)<br>**4. 只输出匹配部分：** `grep -o "[0-9]\{1,3\}\.[0-9]\{1,3\}\.[0-9]\{1,3\}\.[0-9]\{1,3\}" log.txt` (提取所有IP)                                                                                                                                                                                                                    |
